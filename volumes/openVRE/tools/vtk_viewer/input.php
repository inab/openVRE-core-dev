		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
			 ...
			 <div class="form-body">
				...
				<?php } else { ?>
					<div class="col-md-6">
						<?php $ff = matchFormat_File($tool['input_files']['object_file']['file_type'], $inPaths); ?>
						<?php InputTool_printSelectFile($tool['input_files']['object_file'], $rerunParams['object_file'], $ff[0], false, true); ?>
					</div>
				<?php } ?>
			     </div>
