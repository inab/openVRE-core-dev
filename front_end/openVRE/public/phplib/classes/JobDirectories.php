...
class JobDirectories
{
    ...
    readonly ?string $userDir;          // root_dir  = $GLOBALS['userDataDir'] . "/" . $_SESSION['User']['internalId'] User dataDir. Path as seen by VRE
    readonly ?string $userDirHost; // root_dir_host  = $GLOBALS["host_path"].$GLOBALS['pubDir'] . "/" . $_SESSION['User']['internalId']
