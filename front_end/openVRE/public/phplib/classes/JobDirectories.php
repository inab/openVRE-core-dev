...
{
    readonly ?string $projectDirHost; // pub_dir_host = $GLOBALS['clouds'][$cloudName]["dataDir_host"]
    ...
    readonly ?string $userDir;          // root_dir  = $GLOBALS['userDataDir'] . "/" . $_SESSION['internalUserId'] User dataDir. Path as seen by VRE
    readonly ?string $userDirHost; // root_dir_host  = $GLOBALS['clouds'][$cloudName]["pubDir_host"] . "/" . $_SESSION['internalUserId']
